...
if (isset($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        // insert quote
        $stmt = $dbconnect -> prepare("INSERT INTO `quotes` (`Author_ID`,
        `Quote`, `Subject1_ID`, `Subject2_ID`, `Subject3_ID`) VALUES 
        (?, ?, ?, ?, ?); ");
        $stmt -> bind_param("isiii", $author_ID, $quote, $subject_ID_1,
        $subject_ID_2, $subject_ID_3);
        $stmt -> execute();
